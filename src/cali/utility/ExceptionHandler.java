...
//        String translation = Translator.getInstance().getTranslation(offendingColumn);
//
...
//            String offendingColumn = lastPart.substring(lastPart.indexOf("'") + 1, lastPart.lastIndexOf("'"));
//            String translation = Translator.getInstance().getTranslation(offendingColumn);
...
//        return "Fel vid konvertering av datatyp " + parts[parts.length - 3] + " till " + parts[parts.length - 1];
//    }
//
...
//            case "STUDIES_PK":
//                return "Student med personnummer " + parts[0] + " läser redan kurs " + parts[1];
//            case "STUDIED_PK":
//                return "Student med personnummer " + parts[0] + " har redan slutfört kurs " + parts[1];
//            case "COURSE_PK":
