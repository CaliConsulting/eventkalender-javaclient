...
public class EventkalenderServiceLocator extends org.apache.axis.client.Service implements eventkalender.cali.EventkalenderService {
    ...
    public EventkalenderServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public eventkalender.cali.EventkalenderServiceSoap getEventkalenderServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            eventkalender.cali.EventkalenderServiceSoap12Stub _stub = new eventkalender.cali.EventkalenderServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (eventkalender.cali.EventkalenderServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                eventkalender.cali.EventkalenderServiceSoap12Stub _stub = new eventkalender.cali.EventkalenderServiceSoap12Stub(new java.net.URL(EventkalenderServiceSoap12_address), this);
                _stub.setPortName(getEventkalenderServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (eventkalender.cali.EventkalenderServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
